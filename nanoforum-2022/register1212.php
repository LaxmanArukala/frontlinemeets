 ...
 <section id="cta" class="cta">
		...
		<div class="row">
                <div class="col-md-12 nopadding">
                    ...
                    <div class="content-left abstract-totol">
                        <div style="width: 100%;margin:0 auto;">
                              <form style="margin: 20px 0 50px;" action="#" method="post">
                                <div class="row">
                                    <div class="col-md-5">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="upper" for="name"> Title<star class="star">*</star>: </label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control required" name="name" value="" placeholder="Enter name" id="name" required="">
                                      ...
                                      <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control required" name="email" value="" placeholder="Enter Email" id="email" aria-required="true">
                                                                                        </div>
                                       </div>
                                          <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="upper" for="phone"> Phone*: </label>
                                            <input type="text" class="form-control required" name="phone" value="" placeholder="Enter Phone" id="phone" aria-required="true">
                                                                                </div>
                                    </div>
                                          <div class="col-md-12">
                                        <div class="form-group">
...
<div class="col-md-4">
  ...
  <div class="col-md-4">
  <input type="radio" name="amount" id="option3" value="99" onchange="updateAmount()">
  <label for="option3" class="register__button">
      ...
      <h3 class="register__main-feature">$ 99</h3>
                                    ...
                                    <!--<div class="pack-details">
                                       <h5> Oral Presentation</h5>
                                        ...
                                        <label class="container">
                                            <input type="radio" name="amount" value="249" checked="checked" onchange="updateAmount()">
                                            <span class="checkmark"></span>
                                          </label>
                                    </div> 
                                    <div class="pack-details">
                                        <h5> Delegate / Listener</h5>
                                         <p>$199</p>
                                         <label class="container">
                                            <input type="radio" name="amount" value="199" onchange="updateAmount()">
                                            <span class="checkmark"></span>
                                          </label>
                                     </div> 
                                     <div class="pack-details">
                                        <h5>E-Poster Presentation</h5>
                                         <p>$99</p>
                                         <label class="container">
                                            <input type="radio" name="amount" value="99" onchange="updateAmount()">
                                            <span class="checkmark"></span>
                                          </label>
                                     </div> -->
                                 </div>
                                    <div class="summary-block">
                                        ...
                                        <div style="padding-top: 40px;text-align: center;"></div><span><input type="submit" class="btn btn-primary" value="Proceed to Register"></span><span class="btn btn-secondary">Reset</span></div>
                                    </form></div>
