 <header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
						...
						<div class="item active" style="background-image: linear-gradient(360deg, rgb(27 28 29 / 4%), rgb(12 12 12 / 6%)), url('images/sliders/03.jpg');">
	      <div class="caption">
...
<div class="col-md-6">
		...
		<div class="item" style="background-image: linear-gradient(360deg, rgb(27 28 29 / 4%), rgb(12 12 12 / 6%)), url('images/sliders/01.jpg');">
	      <div class="caption">
            <h1 class="animated fadeInLeftBig"><?php echo $main_title[0]; ?><span> <?php echo $main_title[1]; ?></span></h1>
            <p class="animated fadeInRightBig">Theme : <?php echo $r1['Theme']; ?></p>
            <p class="animated fadeInRightBig"><?php echo $r1['ShortName']; ?></p>
