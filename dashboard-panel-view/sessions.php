...
//--------------------DELETE -----------------------		
			...
			if($id!="")
			{
					...
					unlink($d_photo);								
					//-----------------------------
					@$cms_del = "delete from topics_tblstr_d where id='$id'";
          ...
          <div class="row">
             <div class="col-12 mb-4">
				...
				?>
                      ...
                      <td><img src="../uploads/trackimages/<?php echo $row['track_img'];?>" width="50px" height="50px"></td>
