...
if(!isset($_SESSION['sess_member']))
{
	header('location:index');
		...
		{
			@$id = @$_GET['id'];		
			@$qrx_edus = "select *from Speakers_tblstr_d where id='$id'";
		...
		//-----------------				
			...
			{*/						
			    mysqli_query($con,"insert into Speakers_tblstr_d(name,affiliation,user,biography,research,network,abstract,pub2,pub3,pub4) values('$name','$affiliation','$mem_id','$biography','$research','$network','$abstract','$pub2','$pub3','$pub4')") or die(mysqli_error());	
			...
			if($pic1name1 != "")
			{
					...
					$pic1new1 = @$sk_id."-speakers.".$pic1arr1[count($pic1arr1)-1];
					...
					$sql="update Speakers_tblstr_d set photo='$pic1new1' where id='$sk_id'";
			...
			mysqli_query($con,"update Speakers_tblstr_d set name='$name',affiliation='$affiliation',biography='$biography',research='$research',network='$network',abstract='$abstract',pub2='$pub2',pub3='$pub3',pub4='$pub4' where id='$id'");	
			//------------------File Attachment 1 ---------------		    
			@$pic1name1 = $_FILES['photo']['name'];
			if($pic1name1 != "")
			{
					$pic1arr1 = explode(".",$pic1name1);
					@$pic1new1 = @$id."-speakers.".$pic1arr1[count($pic1arr1)-1];
					
					if($_FILES["photo"]["type"]=="image/jpeg" || $_FILES["photo"]["type"]=="image/jpg" || $_FILES["photo"]["type"]=="image/gif"  || $_FILES["photo"]["type"]=="image/png")
						{
					
					move_uploaded_file($_FILES['photo']['tmp_name'], $uploaddir.$pic1new1);
					@$sql="update Speakers_tblstr_d set photo='$pic1new1' where id='$id'";
					@$res=mysqli_query($con,$sql) or die(mysqli_error());					
			}	
			}
			chmod("../uploads/speakers/".$pic1new1,0777);			
        ...
        <section class="section">
           <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="#">Add   Speakers</a></div>
