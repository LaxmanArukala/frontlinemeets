...
//--------------------DELETE -----------------------		
			...
			if($id!="")
			{
			        @$q_fres = mysqli_query($con,"select *from Speakers where id='$id'");
					...
					unlink($d_photo);								
					//-----------------------------
					@$cms_del = "delete from Speakers where id='$id'";
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        <tr>
						 ...
						 <?php
				$query  = "SELECT *FROM Speakers WHERE user='".$_SESSION['sess_member']."' ORDER BY recordListingID ASC";
