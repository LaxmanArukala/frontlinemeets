	...
	if(mysqli_num_rows($meta_tags_result)>0)
{
	if(isset($_POST['update']))
	{
		...
		header('Location: conff_meta_tags');
             ...
             <div class="col-12 mb-4">
                <div class="card">
				  ...
				  <form method="post" action="#"> 
					...
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Committee Keywords</label>
                      <div class="col-sm-6">
                        <textarea class="form-control" name="ocm_keywords" style="height: 100px !important;"><?php echo stripslashes($row['ocm_keywords']) ?></textarea>
						<span style="color:red">Committee Page Section Note: Each keyword seperated by "<strong>,</strong>" and Keywords should be upto 80 words.</span>
                      </div>
                    </div>
					
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Committee Description</label>
                      <div class="col-sm-6">
                        <textarea class="form-control" name="ocm_description" style="height: 100px !important;"><?php echo stripslashes($row['ocm_description']) ?></textarea>
						<span style="color:red">Committee Page Section Note: Description should be upto 160 characters.</span>
                      </div>
                    </div>
					
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Committee Title Bars</label>
                      <div class="col-sm-6">
                        <textarea class="form-control"  name="ocm_title_bars" style="height: 100px !important;"><?php echo stripslashes($row['ocm_title_bars']) ?></textarea>
						<span style="color:red">Committee Page Section Note: Title Bars should be upto 160 characters.</span>
                      </div>
                    </div>
