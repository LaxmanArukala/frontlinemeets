...
{		
	...
	if(stat!="")
	{
			if(id!="")
			{
			     location.href="topics?track_id="+track_id;
			}
	}
	else
		{ 
      ...
      <div class="main-content">
        <section class="section">
		  ...
		  <div class="row">
			 ...
			 <a href="add-sessions"  class="prs1 btn btn-icon icon-left btn-info">
             ...
             <div class="col-12 mb-4">
				...
				?>
                        <tr>
                          ...
                          <td><a href="add-sessions?track_id=<?php echo @$row['track_id']; ?>" class="prs1 btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
						  <td><a onclick='javascript:confirmationDelete($(this));return false;' href="delete?track_id=<?php echo @$row['track_id'];  ?>" class="prs1 btn btn-icon btn-danger"><i class="fas fa-trash"></i> </a></td>
