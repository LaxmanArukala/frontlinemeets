...
if(!isset($_SESSION['sess_member']))
{
	header('location:index.php');
		...
		{
			@$id = @$_GET['id'];		
			@$qrx_edus = "select *from collaborations_tblstr_d where id='$id'";
		...
		//-----------------				
			...
			$collaboration_name			=	$_POST['collaboration_name'];			
			$link			=	$_POST['link'];			
			$description	=	mysqli_real_escape_string($con,$_POST['description']);				

			    mysqli_query($con,"insert into collaborations_tblstr_d(collaboration_name,link,description,user) values('$collaboration_name','$link','$description','".$_SESSION['sess_member']."')") or die(mysqli_error($con));	
			...
			if($pic1name1 != "")
			{
					...
					$pic1new1 = $sk_id."-collaborations-pic.".$pic1arr1[count($pic1arr1)-1];
					...
					$sql="update collaborations_tblstr_d set photo='$pic1new1' where id='$sk_id'";
			...
			mysqli_query($con,"update collaborations_tblstr_d set collaboration_name='$collaboration_name',link='$link',description='$description' where id='$id'");	
			//------------------File Attachment 1 ---------------		    
			@$pic1name1 = $_FILES['photo']['name'];
			if($pic1name1 != "")
			{
					$pic1arr1 = explode(".",$pic1name1);
					$pic1new1 = $id."-collaborations-pic.".$pic1arr1[count($pic1arr1)-1];
					
					if($_FILES["photo"]["type"]=="image/jpeg" || $_FILES["photo"]["type"]=="image/jpg" || $_FILES["photo"]["type"]=="image/gif"  || $_FILES["photo"]["type"]=="image/png")
									{
					
					move_uploaded_file($_FILES['photo']['tmp_name'], $uploaddir.$pic1new1);
					$sql="update collaborations_tblstr_d set photo='$pic1new1' where id='$id'";
					$res=mysqli_query($con,$sql) or die(mysqli_error());					
			}	
			}
			chmod("photos/".$pic1new1,0777);			
...
<head>
  ...
  <title>Add Collaborations | Dashboard</title>
      ...
      <div class="main-content">
        <section class="section">
           <div class="section-header">
            <h1>Add Collaboration Partners</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="#">Add Collaboration Partners</a></div>
                ...
                <div class="card">
				 ...
				 <?php
                    ...
                    <div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Collaboration Name:</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="collaboration_name" value="<?php echo $edus_rw['collaboration_name'];?>"> 
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Collaboration Partner Link:</label>
                      <div class="col-sm-6">
