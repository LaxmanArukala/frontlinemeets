...
if(!isset($_SESSION['sess_member']))
{
	header('location:index.php');
		...
		{
			@$id = @$_GET['id'];		
			@$qrx_edus = "select *from sup_jour_tblstr_d where id='$id'";
		...
		//-----------------				
			...
			{*/						
			    mysqli_query($con,"insert into sup_jour_tblstr_d(name,field1,user,field2,field3,field4,field5,field6,network) values('$name','$field1','$mem_id','$field2','$field3','$field4','$field5','$field6','$network')") or die(mysqli_error());	
			...
			if($pic1name1 != "")
			{
					...
					//$pic1arr1 = 'pic';
					$pic1new1 ="supporting-journals-@$sk_id." .$pic1arr1[count($pic1arr1)-1];
					...
					$sql="update sup_jour_tblstr_d set photo='$pic1new1' where id='$sk_id'";
					$res=mysqli_query($con,$sql) or die(mysqli_error());					
			}
			}
			chmod("../uploads/journals/".$pic1new1,0777);	
			
			//---------------------------------------------------								
				header("location:supporting-journals.php");			
			//}	
			 	}
			else
				{
			...
			mysqli_query($con,"update sup_jour_tblstr_d set name='$name',field1='$field1',field2='$field2',field3='$field3',network='$network',field4='$field4',field5='$field5',field6='$field6' where id='$id'");	
			//------------------File Attachment 1 ---------------		    
			@$pic1name1 = $_FILES['photo']['name'];
			if($pic1name1 != "")
			{
					...
					$pic1arr1 = explode(".",$pic1name1);
					//$pic1arr1 = 'pic';
				 @$pic1new1 = "supporting-journals-$id." .$pic1arr1[count($pic1arr1)-1];
					...
					move_uploaded_file($_FILES['photo']['tmp_name'], $uploaddir.$pic1new1);
					@$sql="update sup_jour_tblstr_d set photo='$pic1new1' where id='$id'";
					@$res=mysqli_query($con,$sql) or die(mysqli_error());					
			}	
			}
			chmod("../uploads/journals/".$pic1new1,0777);			
...
<head>
  ...
  <title>Add Supporting Journals | Dashboard</title>
      ...
      <div class="main-content">
        <section class="section">
           <div class="section-header">
            <h1>Add Supporting Journals</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="#">Add Supporting Journals</a></div>
                ...
                <div class="card">
				  ...
				  <form action="" method="post" enctype="multipart/form-data" name="register" id="register">
				   ...
				   <?php
					...
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Journal Photo</label>
                      <div class="col-sm-6">
                    ...
                    <?php
					  ...
					  { ?>
									  <br />
										<img src="../uploads/journals/<?php echo @$edus_rw['photo']; ?>" border="0" width="85" height="119"/>
										<?php
					  } ?>
                    </div>
                      </div>
					...
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Content 5</label>
                      <div class="col-sm-6">
                        <textarea name="field5"  class="form-control"><?php echo @$edus_rw['field5'];?></textarea>
                      </div>
                    </div>
					
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Content 6</label>
                      <div class="col-sm-6">
                        <textarea name="field6"  class="form-control"><?php echo @$edus_rw['field6'];?></textarea>
                      </div>
                    </div>
