...
if(!isset($_SESSION['sess_member']))
{
	header('location:index.php');
		...
		{
			@$id = @$_GET['id'];		
			@$qrx_edus = "select *from benefits_pub_tblstr_d where id='$id'";
		...
		//-----------------				
			...
			{*/						
			    mysqli_query($con,"insert into benefits_pub_tblstr_d(name,field1,user,field2,field3,field4,field5,field6,network) values('$name','$field1','$mem_id','$field2','$field3','$field4','$field5','$field6','$network')") or die(mysqli_error());	
			...
			if($pic1name1 != "")
			{
					...
					$sql="update benefits_pub_tblstr_d set photo='$pic1new1' where id='$sk_id'";
			...
			mysqli_query($con,"update benefits_pub_tblstr_d set name='$name',field1='$field1',field2='$field2',field3='$field3',network='$network',field4='$field4',field5='$field5',field6='$field6' where id='$id'");	
			//------------------File Attachment 1 ---------------		    
			@$pic1name1 = $_FILES['photo']['name'];
			if($pic1name1 != "")
			{
				 ...
				 @$pic1new1 = "supporting-journals-$id." .$pic1arr1[count($pic1arr1)-1];
					...
					move_uploaded_file($_FILES['photo']['tmp_name'], $uploaddir.$pic1new1);
					@$sql="update benefits_pub_tblstr_d set photo='$pic1new1' where id='$id'";
					@$res=mysqli_query($con,$sql) or die(mysqli_error());					
			}	
			}
			chmod("../uploads/journals/".$pic1new1,0777);			
...
<head>
  ...
  <title>Add Benefits of Publications | Dashboard</title>
      ...
      <div class="main-content">
        <section class="section">
           <div class="section-header">
            <h1>Add Benefits of Publications</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="#">Add Benefits of Publications</a></div>
