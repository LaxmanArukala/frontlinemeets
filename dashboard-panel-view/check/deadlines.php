...
$result = mysql_query("select tracks from callforabstracts where conference='deadlines'");
?>
...
<body>
	...
	<br /><br /><p align="center"><h2>&nbsp;&nbsp;&nbsp;&nbsp;Edit Your DEADLINES Page Here</h2></p><br /><br />
	<form action="assets/submitdeadlines.php" method="post">
