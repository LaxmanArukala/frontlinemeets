...
if(!isset($_SESSION['sess_member']))
{
	...
	if(mysqli_num_rows($important_details_result)>0)
	{
			...
			{					
			    ...
			    $ins = mysqli_query($con,"update important_details_tblstr_d set ShortName='".$_POST['ShortName']."',ConfUrl='".$_POST['ConfUrl']."',Theme='$theme1',EmailId1='".$_POST['EmailId1']."',abstract_submission_opens='".$_POST['abstract_submission_opens']."',registration_opens='".$_POST['registration_opens']."',EarlyBird='".$_POST['EarlyBird']."',mid_term='".$_POST['mid_term']."',OnSpot='".$_POST['OnSpot']."',ConferenceTitle='$ConferenceTitle',ConferenceVenue='".$_POST['ConferenceVenue']."',ConferenceDates='".$_POST['ConferenceDates']."',abstract_submission_deadline='".$_POST['abstract_submission_deadline']."',timer='".$_POST['timer']."',conferncefull_venue='$conferncefull_venue',linkeddin='$linkeddin',EmailId2='".$_POST['EmailId2']."',full_paper_sub='".$_POST['full_paper_sub']."',fb='$fb',tweet='$tweet',twitter='$twitter' where id='".$_SESSION['sess_member']."'");	                  
				if($ins)
				{
	...
	else
	{
		if(isset($_POST['submit']))
		{
			...
			$ConferenceTitle	=	$ConferenceTitle1."<br>".$ConferenceTitle2;				
			$theme1	=	mysqli_real_escape_string($con,$_POST['Theme1']);	
			$ins = mysqli_query($con,"insert into important_details_tblstr_d(id,ShortName,ConfUrl,Theme,EmailId1,EmailId2,fb,tweet,twitter,conferncefull_venue,linkeddin,abstract_submission_opens,abstract_submission_deadline,registration_opens,EarlyBird,mid_term,OnSpot,ConferenceTitle,ConferenceVenue,ConferenceDates,full_paper_sub,timer) values('".$_SESSION['sess_member']."','".$_POST['ShortName']."','".$_POST['ConfUrl']."','$theme1','".$_POST['EmailId1']."','".$_POST['EmailId2']."','$fb','$tweet','$twitter','$conferncefull_venue','$linkeddin','".$_POST['abstract_submission_opens']."','".$_POST['abstract_submission_deadline']."','".$_POST['registration_opens']."','".$_POST['EarlyBird']."','".$_POST['mid_term']."','".$_POST['OnSpot']."','$ConferenceTitle','".$_POST['ConferenceVenue']."','".$_POST['ConferenceDates']."','".$_POST['full_paper_sub']."','".$_POST['timer']."')") or die(mysqli_error($con));			
			if($ins)
			{
          ...
          <div class="row">
             <div class="col-12 mb-4">
               <div class="card">
                    ...
                    <!--<div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Full Paper Submission:</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control"  name="full_paper_sub" id="full_paper_sub" value="<?php echo $row['full_paper_sub'];?>">
                      </div>
                    </div>-->
					<div class="form-group row">
					...
					<div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Standard Registrations Dates:</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="mid_term" id="OnSpot" value="<?php echo $row['mid_term'];?>">
                      </div>
                    </div>
					<div class="form-group row">
