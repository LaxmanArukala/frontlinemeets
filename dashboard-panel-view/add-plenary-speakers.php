	...
	header('location:index');
		...
		//-----------------				
			...
			if($pic1name1 != "")
			{
					...
					$pic1new1 = "pspeaker-$sk_id".$pic1arr1[count($pic1arr1)-1];
			...
			{
					$pic1arr1 = explode(".",$pic1name1);
					@$pic1new1 = "pspeaker-$id.".$pic1arr1[count($pic1arr1)-1];
                ...
                <div class="card">
				  ...
				  <form action="" method="post" enctype="multipart/form-data" name="register" id="register">
				   ...
				   <?php
					...
					<!-- <div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">CONFERENCE CHAIR & KEYNOTE SPEAKER</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="pub2" class="textbox" value="<?php echo @$edus_rw['pub2'];?>">
                      </div>
                    </div>-->
					
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Speech Title:</label>
                      <div class="col-sm-6">
