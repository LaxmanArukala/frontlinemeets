...
$r=mysqli_query($con,"select * from pdfs_tblstr_d where id='$id'");
...
//===================
            $add_res=mysqli_query($con,"INSERT INTO `pdfs_tblstr_d` (`tentative_program` ,`Brochure` ,`conferenceguide` ,`program` ,`id`) VALUES ('$tentative_program', '$brochure','$conferenceguide', '$program', '$id')");
			...
			if($pic1name1 != "")
			{
					...
					$pic1new1 = "-tentative-program.pdf";
					//$pic1new1 = $_SESSION['cname']."-tentative-program.pdf";
					move_uploaded_file($_FILES['tentative_program']['tmp_name'], $uploaddir.$pic1new1);
					$sqlqq="update pdfs_tblstr_d set tentative_program='$pic1new1' where id='$id'";
					$resqq=mysqli_query($con,$sqlqq) or die(mysqli_error($con));					
			}
			...
			if($pic1name3 != "")
			{
					...
					$pic1new3 = $_SESSION['cname']."-abstract-book.pdf";
					//$pic1new3 = $id."-abstract-book.pdf";
					move_uploaded_file($_FILES['conferenceguide']['tmp_name'], $uploaddir.$pic1new3);
					$sqlqq="update pdfs_tblstr_d set Conferenceguide='$pic1new3' where id='$id'";
					$resqq=mysqli_query($con,$sqlqq) or die(mysqli_error($con));					
			}
			...
			if($pic1name4 != "")
			{
					...
					$sqlqq="update pdfs_tblstr_d set eform_usa='$pic1new4' where id='$id'";
					$resqq=mysqli_query($con,$sqlqq) or die(mysqli_error($con));					
			}
			...
			if($pic1name5 != "")
			{
					...
					$sqlqq="update pdfs_tblstr_d set Sponsorship='$pic1new5' where id='$id'";
					$resqq=mysqli_query($con,$sqlqq) or die(mysqli_error($con));					
			}
			...
			if($pic1name6 != "")
			{
					...
					$pic1new6 = $_SESSION['cname']."-program.pdf";
					//$pic1new6 = $id."_program.pdf";
					move_uploaded_file($_FILES['program']['tmp_name'], $uploaddir.$pic1new6);
					$sqlqq="update pdfs_tblstr_d set program='$pic1new6' where id='$id'";
					$resqq=mysqli_query($con,$sqlqq) or die(mysqli_error($con));					
			}
			chmod("../uploads/docs/".$pic1new1,0777);
			chmod("../uploads/docs/".$pic1new2,0777);
			chmod("../uploads/docs/".$pic1new3,0777);
			chmod("../uploads/docs/".$pic1new4,0777);
			chmod("../uploads/docs/".$pic1new5,0777);
			chmod("../uploads/docs/".$pic1new6,0777);
		
			//-----------------------------------
    
header("location:upload-pdfs");
...
//===================
			...
			{
					$pic1arr1 = explode(".",$pic1name1);
					$pic1new1 = $id."-tentative-program.pdf";
					//$pic1new1 = $_SESSION['cname']."-tentative-program.pdf";
					move_uploaded_file($_FILES['tentative_program']['tmp_name'], $uploaddir.$pic1new1);
					$sqlqq="update pdfs_tblstr_d set tentative_program='$pic1new1' where id='$id'";
					$resqq=mysqli_query($con,$sqlqq) or die(mysqli_error($con));					
        ...
        <section class="section">
          ...
          <div class="row">
			 ...
			 if(!isset($_POST['Submit']))
			  {
				  ?>
              <form id="register" name="edit" action="upload-pdfs" method="post" enctype="multipart/form-data">
				   
				   <div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Conference Brochure  (PDF)</label>
                      <div class="col-sm-6">
					  <?php if(!$f['Brochure'] == "" || !$f['Brochure'] == null ){
						  echo "<a href='../uploads/docs/".$f['Brochure']."' target='_blank'>".$f['Brochure']."</a>";
					  } ?>
					...
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Program (PDF)</label>
                      <div class="col-sm-6">
					  <?php if(!$f['program'] == "" || !$f['program'] == null ){
						  echo "<a href='../uploads/docs/".$f['program']."' target='_blank'>".$f['program']."</a>";
					  } ?>
                       <div class="custom-file">
					  <input type="file" class="custom-file-input" name="program" value="<?php echo $f['program']; ?>" accept="application/pdf">
                      <label class="custom-file-label" for="customFile">Choose file</label>
					  </div>
                      </div>
                    </div>
					...
					<div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Abstract Book  (PDF)</label>
                      <div class="col-sm-6">
					  <?php if(!$f['Conferenceguide'] == "" || !$f['Conferenceguide'] == null ){
						  echo "<a href='../uploads/docs/".$f['Conferenceguide']."' target='_blank'>".$f['Conferenceguide']."</a>";
					  } ?>
                       <div class="custom-file">
					  <input type="file" class="custom-file-input" name="conferenceguide" value="<?php echo $f['Conferenceguide']; ?>" accept="application/pdf">
                      <label class="custom-file-label" for="customFile">Choose file</label>
					  </div>
                      </div>
                    </div>
					...
					<div class="form-group row">
					  ...
					  <?php if(!$f['tentative_program'] == "" || !$f['tentative_program'] == null ){
						  echo "<a href='../uploads/docs/".$f['tentative_program']."' target='_blank'>".$f['tentative_program']."</a>";
					  } ?>
                       <div class="custom-file">
					...
					<div class="form-group row">
                      ...
                      <div class="col-sm-6">
					   <?php if(!$f['meeting_agenda'] == "" || !$f['meeting_agenda'] == null ){
						  echo "<a href='../uploads/docs/".$f['meeting_agenda']."' target='_blank'>".$f['meeting_agenda']."</a>";
					  } ?>
                       <div class="custom-file">
					...
					<div class="form-group row">
                      ...
                      <div class="col-sm-6">
					   <?php if(!$f['eform_usa'] == "" || !$f['eform_usa'] == null ){
						  echo "<a href='../uploads/docs/".$f['eform_usa']."' target='_blank'>".$f['eform_usa']."</a>";
					  } ?>
                       <div class="custom-file">
