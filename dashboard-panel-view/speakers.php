...
$(document).ready(function(){ 
	...
	$(function() {
		$("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
			...
			$.post("updateDB_speakers", order, function(theResponse){
...
<body>
      ...
      <div class="main-content">
        <section class="section">
		  ...
		  <div class="row">
			 ...
			 <a href="add-speakers"  class="prs1 btn btn-icon icon-left btn-info">
  ...
  <div id="contentLeft">
    <ul style="list-style:none">
						<?php
				$query  = "SELECT *FROM Speakers_tblstr_d WHERE user='".$_SESSION['sess_member']."' ORDER BY recordListingID ASC";
	  ...
	  ?></td>
                          ...
                          <td><a href="add-speakers?id=<?php echo @$row['id']; ?>" class="prs1 btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
