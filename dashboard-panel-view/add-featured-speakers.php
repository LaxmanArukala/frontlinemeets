...
if(!isset($_SESSION['sess_member']))
{
	header('location:index');
		...
		{
			@$id = @$_GET['id'];		
			@$qrx_edus = "select *from featured_speakers_tblstr_d where id='$id'";
		...
		//-----------------				
			...
			{*/						
			    mysqli_query($con,"insert into featured_speakers_tblstr_d(name,affiliation,user,biography,research,network,abstract,pub2,pub3,pub4) values('$name','$affiliation','$mem_id','$biography','$research','$network','$abstract','$pub2','$pub3','$pub4')") or die(mysqli_error());	
			...
			if($pic1name1 != "")
			{
					...
					$pic1new1 = "fspeaker-$sk_id".$pic1arr1[count($pic1arr1)-1];
					...
					$sql="update featured_speakers_tblstr_d set photo='$pic1new1' where id='$sk_id'";
			...
			//---------------------------------------------------								
				header("location:featured-speakers");			
			//}	
			}
			else
				{
			...
			mysqli_query($con,"update featured_speakers_tblstr_d set name='$name',affiliation='$affiliation',biography='$biography',research='$research',network='$network',abstract='$abstract',pub2='$pub2',pub3='$pub3',pub4='$pub4' where id='$id'");	
			//------------------File Attachment 1 ---------------		    
			@$pic1name1 = $_FILES['photo']['name'];
			if($pic1name1 != "")
			{
					$pic1arr1 = explode(".",$pic1name1);
					@$pic1new1 = "fspeaker-$id.".$pic1arr1[count($pic1arr1)-1];
					
					if($_FILES["photo"]["type"]=="image/jpeg" || $_FILES["photo"]["type"]=="image/jpg" || $_FILES["photo"]["type"]=="image/gif"  || $_FILES["photo"]["type"]=="image/png")
						{
					
					move_uploaded_file($_FILES['photo']['tmp_name'], $uploaddir.$pic1new1);
					@$sql="update featured_speakers_tblstr_d set photo='$pic1new1' where id='$id'";
					@$res=mysqli_query($con,$sql) or die(mysqli_error());					
			}
			}
			chmod("../uploads/speakers/".$pic1new1,0777);			
...
<head>
  ...
  <title>Add Featured Speakers | Dashboard</title>
      ...
      <div class="main-content">
        <section class="section">
           <div class="section-header">
            <h1>Add Featured Speakers</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="#">Add Featured Speakers</a></div>
