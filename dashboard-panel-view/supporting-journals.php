...
//--------------------DELETE -----------------------		
			...
			if($id!="")
			{
			        @$q_fres = mysqli_query($con,"select *from sup_jour_tblstr_d where id='$id'");
					...
					unlink($d_photo);								
					//-----------------------------
					@$cms_del = "delete from sup_jour_tblstr_d where id='$id'";
...
<head>
  ...
  <title>Supporting Journals | Dashboard</title>
...
{		
	...
	if(stat!="")
	{
			if(id!="")
			{
			     location.href="supporting-journals.php?id="+id;
			}
	}
	else
		{ 
...
<body>
        ...
        <section class="section">
           <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="#">Supporting Journals</a></div>
		  ...
		  <div class="row">
			 ...
			 <a href="add-supporting-journals.php"  class="prs1 btn btn-icon icon-left btn-info">
			 
			 <b> <i class="fas fa-plus"></i>Add  Journals</b></a>
			 </div>
			 </div>
			 <br>
          <div class="row">
  ...
  <div id="contentLeft">
    <ul style="list-style:none">
						<?php
				$query  = "SELECT *FROM sup_jour_tblstr_d WHERE user='".$_SESSION['sess_member']."' ORDER BY recordListingID ASC";
				...
				<div class="table-responsive">
						...
						<tr>
                          ...
                          <td><a href="add-supporting-journals.php?id=<?php echo @$row['id']; ?>" class="prs1 btn btn-icon btn-primary"><i class="far fa-edit"></i></a></td>
