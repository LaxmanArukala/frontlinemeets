...
if(!isset($_SESSION['sess_member']))
{
	header('location:index');
		...
		{
			@$id = @$_GET['id'];		
			@$qrx_edus = "select *from media_partners_tblstr_d where id='$id'";
		...
		//-----------------				
			if(isset($_POST['add']))
			{	
            $mediapartner_name			=	$_POST['mediapartner_name'];			
			$link			=	$_POST['link'];			
			$description	=	mysqli_real_escape_string($con,$_POST['description']);				

			    mysqli_query($con,"insert into media_partners_tblstr_d(mediapartner_name,link,description,user) values('$mediapartner_name','$link','$description','".$_SESSION['sess_member']."')") or die(mysqli_error($con));	
			...
			if($pic1name1 != "")
			{
					...
					$pic1new1 = "mediapartners-$sk_id.".$pic1arr1[count($pic1arr1)-1];
					...
					$sql="update media_partners_tblstr_d set photo='$pic1new1' where id='$sk_id'";
					$res=mysqli_query($con,$sql) or die(mysqli_error());					
			}
			}
			chmod("../uploads/media/".$pic1new1,0777);	
			...
			mysqli_query($con,"update media_partners_tblstr_d set mediapartner_name='$mediapartner_name',link='$link',description='$description' where id='$id'");	
			//------------------File Attachment 1 ---------------		    
			@$pic1name1 = $_FILES['photo']['name'];
			if($pic1name1 != "")
			{
					$pic1arr1 = explode(".",$pic1name1);
					@$pic1new1 = "mediapartners-$id.".$pic1arr1[count($pic1arr1)-1];
					//$pic1new1 = "mediapartners-$id"."$pic1arr1[count($pic1arr1)-1];
					...
					move_uploaded_file($_FILES['photo']['tmp_name'], $uploaddir.$pic1new1);
					$sql="update media_partners_tblstr_d set photo='$pic1new1' where id='$id'";
					$res=mysqli_query($con,$sql) or die(mysqli_error());					
			}	
			}
			chmod("../uploads/media/".$pic1new1,0777);			
...
<head>
  ...
  <title>Add Media Partners | Dashboard</title>
      ...
      <div class="main-content">
        <section class="section">
           <div class="section-header">
            <h1>Add Media Partners</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="#">Add Media Partners</a></div>
                ...
                <div class="card">
				 ...
				 <?php
                    ...
                    <div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Media Partner Name:</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="mediapartner_name" value="<?php echo $edus_rw['mediapartner_name'];?>"> 
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputName3" class="col-sm-3 col-form-label">Media Partner Link:</label>
                      <div class="col-sm-6">
					  ...
					  <?php
						  ...
						  { ?>
										  ...
										  <span style="color: red">Image should be exactly of size 300 X 200 pixels</span>
										   <br>
											<img src="../uploads/media/<?php echo @$edus_rw['photo']; ?>" border="0" width="85" height="85"/>
											<?php
						  } ?>
                    </div>
                      </div>
