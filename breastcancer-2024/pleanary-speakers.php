...
// 		include("functions.php");	
		$query  = "SELECT * FROM plenary_speakers_tblstr_d where user = 3 ORDER BY recordListingID ASC";
                    ...
                    <div class="col-md-4">
						...
						<!--<a href="#" target="_blank">-->
						  ...
						  <div class="content-details fadeIn-bottom">
							...
							<p class="content-text mb-3"><?php echo $row['affiliation'];?></p>
                            <p class="content-text"><?php echo $row['biography'];?></p>
						  </div>
						<!--</a>-->
					    </div>
