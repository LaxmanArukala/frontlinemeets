                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message event-title text-center">
                            ...
                            <!-- <a href="submit-abstract" class="btn btn-primary" style="padding: 20px 44px;margin-right: 10px;border-radius: 10px;">Submit Abstract<br></a>
                            <a href="register" class="btn btn-warning" style="padding: 20px 44px;border-radius: 10px;margin-right: 10px;">Register Now<br></a>
							<a href="register" class="btn btn-warning" style="padding: 20px 44px;border-radius: 10px;">Program<br></a> -->
                        </div>
						<br>
						...
						<!-- <div class="col-md-6">
							<a href="#"class="cl-w">
                               ...
                               <p class="text-white">
                                 <b>
                                  <?php //echo $r1['abstract_submission_opens']; ?>
                                 </b>
                                </p>
                            </a>
							 </div> -->
        ...
        <section class="section sess-bg" style="padding: 0em !important;">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Sessions Sectin start -->
					
                </div><!-- end row -->
            </div><!-- end container -->
        </section>
        <!-- Registration Categories start -->
