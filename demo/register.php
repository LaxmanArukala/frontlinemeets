                    ...
                    <div class="row blog-grid">
                        <div class="col-md-12">
                            <div class="course-box">
                               <form name="reg" method="post" action="payapl.php" class=" " onsubmit="return test(this);" enctype="multipart/form-data">
								<div><input type="radio" name="payment" value="paypal" id="selectedpaypal" checked="checked">  
                                 <div class="row">
                                     <div class="col-md-6">
								 ...
								 <div class="panel panel-default">
									...
									<div class="panel-body text-center">
										<h4><input type="radio" name="amount" id="option1" value="249" checked  onchange="updateAmount()"> $ 249 Oral Presentation</h4>
										 
									  <hr>
									   <h4><input type="radio" name="amount" id="option2" value="199" onchange="updateAmount()"> $ 199 Delegate / Listener</h4>
									  <hr>
									   
									     <h4><input type="radio" name="amount" id="option2" value="129" onchange="updateAmount()"> $ 129 E-Poster Presentation</h4>
									    <hr>
									      <h4 class="register__title"><input type="radio" name="amount" id="option2" value="99" onchange="updateAmount()"> $ 99 Student</h4>
										  <hr>
								 ...
								 <div class="panel panel-default">
									...
									<div class="panel-body text-center">
									     ...
									     <h4><input type="radio" name="amount" id="option1" value="" disabled  onchange="updateAmount()"> $ 249 Oral Presentation</h4>
									  <hr>
									   	  <h4><input type="radio" name="amount" id="option2" value="" disabled onchange="updateAmount()"> $ 199 Delegate / Listener</h4>
									    <hr>
									   
									     <h4><input type="radio" name="amount" id="option2" value="" disabled onchange="updateAmount()"> $ 129 E-Poster Presentation</h4>
									    <hr>
									    <h4><input type="radio" name="amount" id="option2" value="" disabled onchange="updateAmount()"> $ 99 Student</h4>
										  <hr>
								...
								<div class="panel panel-default">
								 ...
								 <div class="panel-heading col-md-4"><button type="button" class="btn btn btn-default btn-block"> 
								  <input type="radio" name="Accommodation" id="option2" value="200" checked   onchange="updateAmount()"> $ 200  Accommodation for One Night </button> </div> 
								 <div class="panel-heading col-md-4"><button type="button" class="btn btn btn-default btn-block"> <input type="radio" name="Accommodation" id="option2" value="300"   onchange="updateAmount()"> $ 300 Accommodation for Two Nights</button></div> 
								 <div class="panel-heading col-md-4"><button type="button" class="btn btn btn-default btn-block"><input type="radio" name="Accommodation" id="option2" value="400"   onchange="updateAmount()"> $ 400 Accommodation for Three nights</button></div> 
								  </div>
                                    ...
                                    <div class="summary-block">
                                        ...
                                        <div class="price-block"><span class="price-bloc-headding col-md-8"><b>Registration Price:</b></span><span class="col-md-4" id="reg_price"> $ 249</span></div><hr>
										<div class="price-block"><span class="price-bloc-headding col-md-8"><b>Accomidation Price:</b></span><span class="col-md-4" id="acc_price">  $ 200</span></div><hr>
                                        <div class="price-block"><span class="price-bloc-headding col-md-8"><b>Participants:</b></span><span class="col-md-4" id="reg_participants"> $ 0</span></div><hr>
                                        <div class="price-block"><span class="price-bloc-headding col-md-8"><b>Total Registration Price:</b></span><span class="col-md-4" id="total_amount"> </span></div>
										  
										  <input type="text" name="amount" id="amount" hidden="">
										
										<div class="paybox1 col-md-12" align="center">
                                    <img src="captcha_code_file.php?rand=1131699087" id="captchaimg"><br>
								...
								<div style=" "><input type="checkbox" name="checkbox" checked="checked"> I have read and agree with the <a href="#" target="_blank" style=" ">Terms And Conditions</a></div> <br></div>
                                        ...
                                        <div align="center"><input type="submit" class="btn btn-primary" name="submit" value="Proceed to Register"><!--<span class="btn btn-secondary">Reset</span>--></div>
										</div>
                                    </div></form>
                            </div><!-- end box -->
                        </div><!-- end col -->
