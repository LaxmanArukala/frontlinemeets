...
if($sent){
	echo "<span style='color:green; font-weight:bold;'>Your request has been submitted. Please <a href='download.php?download_file=AG-PHHM-Forum-Brochure.pdf'>click here to download brochure</a></span>";
  }
