...
<head>
  ...
  <link href="css/vd-bg.css" rel="stylesheet">
...
<section id="team">
 ...
 <!-- <section id="team">
  ...
  <section id="hero" class="d-flex flex-column justify-content-center parallax">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-8">
          <h1>Auragen Group began to address the problem and sought to clarify the overall goal of scientific researchers </h1>
          <h2>centered in the field of science and innovation to support the exchange of ideas and information</h2>
          <a href="https://www.youtube.com/playlist?list=PLfv05kfjBuRmcAUGBdu-NBSUkFcfIacsG" target="_blank" class="glightbox play-btn mb-4"></a>
        </div>
      </div>
    </div>
  </section>
