...
<head>
    ...
    <!-- Site Meta -->
    <title><?php echo $row_meta['ocm_title_bars'];?></title>

   <meta content="<?php echo $row_meta['ocm_keywords'];?>" name='keywords'/>
  
  <meta content="<?php echo $row_meta['ocm_description'];?>" name='description'/>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message page-title text-center">
                            ...
                            <ul class="breadcrumb">
                                <li><a href="javascript:void(0)">Organizing Committee Members</a></li>
                            </ul>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
