...
<head>
    ...
    <!-- Site Meta -->
    <title><?php echo $main_title[0]; ?> <?php echo $main_title[1]; ?> | Register</title>
                               ...
                               <form name="reg" method="post" action="#" class=" " onsubmit="return test(this);" enctype="multipart/form-data">
								<div><input type="hidden" name="payment" value="paypal" id="selectedpaypal" checked="checked">  
								 ...
								 <div class="panel panel-default">
									...
									<div class="panel-body text-center">
										<h4><input type="radio" name="amount" id="option1" value="699" checked  onchange="updateAmount()"> $ 699 Speaker Registration</h4>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body text-center">
									  ...
									  <hr>
									   	  <h4><input type="radio" name="amount" id="option2" value="" disabled onchange="updateAmount()"> $ 549 Poster Registration</h4>
									    <hr>
									   
									     <h4><input type="radio" name="amount" id="option2" value="" disabled onchange="updateAmount()"> $ 949 Delegate Registration</h4>
									    <hr>
									    <h4><input type="radio" name="amount" id="option2" value="" disabled onchange="updateAmount()"> $ 399 Student Registration</h4>
										  <hr>
										  
										  <h4><input type="radio" name="amount" id="option2" value="" disabled onchange="updateAmount()"> $ 299 E-Poster Registration</h4>
										  <hr>
								 ...
								 <div class="panel-heading col-md-4"><button type="button" class="btn btn btn-default btn-block"> 
								  <input type="radio" name="Accommodation" id="option2" value="180" checked   onchange="updateAmount()"> $ 180  Accommodation for One Night </button> </div> 
								 ...
								 <div class="panel-heading col-md-4"><button type="button" class="btn btn btn-default btn-block"><input type="radio" name="Accommodation" id="option2" value="540"   onchange="updateAmount()"> $ 540 Accommodation for Three nights</button></div> 
                                    ...
                                    <div class="summary-block">
                                        ...
                                        <div class="price-block"><span class="price-bloc-headding col-md-8"><b>Registration Price:</b></span><span class="col-md-4" id="reg_price"> $ 699</span></div><hr>
										<div class="price-block"><span class="price-bloc-headding col-md-8"><b>Accomidation Price:</b></span><span class="col-md-4" id="acc_price">  $ 180</span></div><hr>
