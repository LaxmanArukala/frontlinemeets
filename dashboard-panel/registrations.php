             ...
             <div class="col-12 mb-4">
			  ...
			  <div class="card-header">
                     <h4><?php echo $_SESSION['cname']; ?></h4><br>
					  ...
					  <?php 
					  @$count_result=mysqli_query($con,"select * from tbl_registration_tblstr_d where user='".$_SESSION['cname']."'");
			      ...
			      <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-striped table-md">
                        ...
                        <?php 
						  $select_result=mysqli_query($con,"select * from tbl_registration_tblstr_d where user='".$_SESSION['cname']."' ORDER BY reg_id DESC");
						...
						<tr>
						  ...
						  <td><div class="badge badge-success"><?php echo $rows['txnsttaus'];?></div></td>				
