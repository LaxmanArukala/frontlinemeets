...
$result = mysql_query("select home from homepage where conference='$conference'");
?>
...
<body>
	...
	<br /><br /><p align="center"><h2 style="color:#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;Edit Your Home Page Here</h2></p><br /><br />
	<form action="assets/submithome.php" method="post">
