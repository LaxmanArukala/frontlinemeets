...
$result = mysql_query("select tracks from callforabstracts where conference='participants'");
?>
...
<body>
	...
	<br /><br /><p align="center"><h2>&nbsp;&nbsp;&nbsp;&nbsp;Edit Your participants list</h2></p><br /><br />
	<form action="assets/submitparticipants.php" method="post">
