          ...
          <div class="row">
             <div class="col-12 mb-4">
               <div class="card">
					...
					<div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Mid Term Registrations Dates:</label>
                      <div class="col-sm-6">
