                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-12">
                                     ...
                                     <div class="col-md-12">
										...
										<div class="col-md-12">
                                            <div class="form-group">
                                                <label class="upper" for="email"> Discounted Registration Amount: </label>
                                                <input type="number" class="form-control required" name="amount" value="" placeholder="Discounted Registration Amount" id="email" aria-required="true" required onchange="updateAmount()" >
                                            </div>
                                        </div>
...
<div class="col-md-3">
  <input type="radio" name="amount" id="option4" value="75" onchange="updateAmount()">
  <label for="option4" class="register__button">
      <h3 class="register__title">Student Delegate</h3>
      <h3 class="register__main-feature">$ 75</h3>
    </label>
</div>
</div>-->
